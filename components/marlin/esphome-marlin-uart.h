...
static const char *TAG = "component.Marlin";

class component_Marlin : 
  ...
  public:
    ...
    static component_Marlin* instance(UARTComponent *parent)
    {
        static component_Marlin* INSTANCE = new component_Marlin(parent);
        return INSTANCE;
    }
    ...
    void setup() override
    {
        ...
        register_service(&component_Marlin::set_bed_setpoint, "set_bed_setpoint",
                 {"temp_degC"});
        register_service(&component_Marlin::set_extruder_setpoint, "set_extruder_setpoint",
                {"temp_degC"});       
    }
  ...
  private: 
    ...
    component_Marlin(UARTComponent *parent) : PollingComponent(2000), UARTDevice(parent) 
    {
