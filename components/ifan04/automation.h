...
template<typename... Ts> class TurnOnAction : public Action<Ts...> {
 public:
  explicit TurnOnAction(IFan *state) : state_(state) {}
...
template<typename... Ts> class TurnOffAction : public Action<Ts...> {
 public:
  explicit TurnOffAction(IFan *state) : state_(state) {}
...
template<typename... Ts> class ToggleAction : public Action<Ts...> {
 public:
  explicit ToggleAction(IFan *state) : state_(state) {}
...
template<typename... Ts> class FanIsOnCondition : public Condition<Ts...> {
 public:
  explicit FanIsOnCondition(IFan *state) : state_(state) {}
