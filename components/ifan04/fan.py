...
fan_ns = cg.esphome_ns.namespace("ifan")
IFan = fan_ns.class_("IFan", cg.EntityBase)
FanState = fan_ns.class_("IFan", IFan, cg.Component)
...
FAN_SCHEMA = cv.ENTITY_BASE_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(IFan),
